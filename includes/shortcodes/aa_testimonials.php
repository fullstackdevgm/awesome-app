...
function aa_testimonials($params, $content = null){
	...
	<div class="row">
		<div class="span1">
			<div class="chevrons">
				<div class="row-fluid">
					<div class="span6" id="previous"><a href="#" id="flexi_prev"><i class="icon-chevron-left" style="display:none"></i></a></div>
					<div class="span6" id="next"><a href="#" id="flexi_next"><i class="icon-chevron-right" style="display:none"></i></a></div>
				</div>
			</div>
		</div>
		<div class="span10 flexslider" id="clients_slider">
			<?php 
			global $deviceType;
