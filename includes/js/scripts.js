...
$(".tweet_slider_pr").flexslider({
		...
		before: function() {
			if(testMobile === null) {
				$('.tweet_slider_pr .slides li').css( { 'margin-left': '30px' } );
				$('.tweet_slider_pr .slides li:nth-child(3n+1)').css( { 'margin-left': '0' } );
			}
		},
		end: function() {
			if(testMobile === null) {
				$('.tweet_slider_pr .slides li:nth-child(3n+1)').css( { 'margin-left': '0' } );
				$('.tweet_slider_pr .slides li:nth-last-child(1)').css( { 'margin-left': '30px' } );
				$('.tweet_slider_pr .slides li:nth-last-child(2)').css( { 'margin-left': '30px' } );
				$('.tweet_slider_pr .slides li:nth-last-child(3)').css( { 'margin-left': '0px' } );
				if($('.tweet_slider_pr .slides > li').length % 3 === 1) {
					$('.tweet_slider_pr .slides li:nth-last-child(4)').css( { 'margin-left': '0' } );
				} else if($('.tweet_slider_pr .slides > li').length % 3 === 2) {
					$('.tweet_slider_pr .slides li:nth-last-child(4)').css( { 'margin-left': '20px' } );
				}
			}
		}
	});
